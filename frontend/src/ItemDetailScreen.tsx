      ...
      <section className="detail-layout">
        ...
        <article className="panel detail-panel" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div className="detail-actions">
            ...
            {user?.id !== currentItem.sellerId && currentItem.status === "active" && (
              <>
                ...
                <button type="button" className="primary-button" style={{ background: "linear-gradient(135deg, #d85b46, #e06e57)" }} onClick={() => setShowNegotiation(true)}>
                  🤖 代理AI交渉で購入する
                </button>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "12px" }}>
            ...
            {scene && (
              <button type="button" className="ai-button" disabled={!user || videoLoading} onClick={isPlayingVideo ? () => setIsPlayingVideo(false) : () => void generateSceneVideo()} style={{ flex: 1, background: isPlayingVideo ? "#eadfd3" : "#d85b46", color: isPlayingVideo ? "#1f2933" : "#ffffff", borderColor: isPlayingVideo ? "#eadfd3" : "#d85b46" }}>
                <Bot size={18} />
