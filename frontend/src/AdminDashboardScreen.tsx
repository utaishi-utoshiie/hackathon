  ...
  return (
    <section className="page-shell">
      <div className="split-heading">
        <div>
          <p className="eyebrow" style={{ color: "#4F46E5" }}>Admin Center</p>
          <h2 style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <ShieldAlert size={24} style={{ color: "#4F46E5" }} /> プラットフォーム管理センター
          </h2>
        </div>
      </div>

      <div style={{ display: "flex", borderBottom: "2px solid #edeef5", gap: "16px", margin: "24px 0" }}>
        <button
          onClick={() => onSubpageChange("stats")}
          style={{ background: "none", border: "none", padding: "10px 16px", fontWeight: 600, fontSize: "15px", color: currentSubpage === "stats" ? "#4F46E5" : "#6b6d85", borderBottom: currentSubpage === "stats" ? "3px solid #4F46E5" : "3px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}
        >
          <TrendingUp size={16} /> 統計KPI
        </button>
        <button
          onClick={() => onSubpageChange("moderations")}
          style={{ background: "none", border: "none", padding: "10px 16px", fontWeight: 600, fontSize: "15px", color: currentSubpage === "moderations" ? "#4F46E5" : "#6b6d85", borderBottom: currentSubpage === "moderations" ? "3px solid #4F46E5" : "3px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}
        >
          <Bot size={16} /> AI検知ログ
        </button>
        <button
          onClick={() => onSubpageChange("users")}
          style={{ background: "none", border: "none", padding: "10px 16px", fontWeight: 600, fontSize: "15px", color: currentSubpage === "users" ? "#4F46E5" : "#6b6d85", borderBottom: currentSubpage === "users" ? "3px solid #4F46E5" : "3px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}
        >
...
function AdminUsersView({ api }: { api: <T>(path: string, options?: RequestInit) => Promise<T> }) {
  ...
  return (
    <div className="admin-users-view" style={{ color: "#1A1B2E" }}>
